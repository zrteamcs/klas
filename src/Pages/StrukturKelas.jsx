	...
	return (
		<div className="z-1  relative h-auto lg:h-[83vh] lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Mahdiati S.Pd" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Khatamul" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Ghaysan" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Syifaul" Width="120px" />
						<div className="py-[3%]"></div>
						
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Liza" Width="120px" />
						<div className="py-[3%]"></div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Agama" Nama="Qalbi" Width="120px" />
						<div className="py-[3%]"></div>
						
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Mading" Nama="Fitri" Width="120px" />
						<div className="py-[3%]"></div>
						
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Sosial" Nama="Nadiatul" Width="120px" />
						<div className="py-[3%]"></div>
